...
function OnboardingHeaderComponent() {    
    ...
    return (        
        <div className="border border-b-zinc-200 dark:border-b-zinc-700" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'top', padding: '1px', position: 'sticky', top: '0' }}>
