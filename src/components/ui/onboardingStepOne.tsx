        ...
        <Card className="w-[700px]">
          ...
          <CardContent>
            ...
            <div className="flex items-center space-x-2" style={{ padding: '8px' }}>
              <div className="flex items-center space-x-2 border-2 border-zinc-400 dark:border-zinc-500 hover:bg-zinc-100 rounded-lg" style={{ padding: '8px' }}>  
                <Checkbox id="founder" className="border border-zinc-400 dark:border-zinc-500"/>
                <label
                  htmlFor="founder"
